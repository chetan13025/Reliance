...
public class Reliance_Spark extends PRD_upload {
...
//		PRD_upload.web();
		...
		dc.setCapability(MobileCapabilityType.DEVICE_NAME, "TECNO SPARK7");
		...
		driver.findElement(By.id(Search_field)).sendKeys("10085058");
